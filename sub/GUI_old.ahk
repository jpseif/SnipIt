...
Gui, Font, s8, Verdana
Gui, Add, Text, x20 y20, Snippets
Gui, Add, ListBox, x20 y+5 w100 h200 Multi vChosenKey, %KeyList%
Gui, Add, Text, x+10 y20, ...to be replaced by
Gui, Add, ListBox, xp y+5 w300 h200 ReadOnly vChosenValue, %ValueList%
...
Gui, Add, Button, xp y+5 w150, Continue
